...
public class jPanelVariosDocumentos extends javax.swing.JPanel {
	...
	public static void main(String args[]) {
		...
		btnSalir.setIcon(IconFontSwing.buildIcon(GoogleMaterialDesignIcons.CLOSE, 16, Main.color));
		...
		JOptionPane.showOptionDialog(null, jPanelVariosDocumentos, "Documentos firmados", JOptionPane.OK_OPTION,
		...
		jtblDocumentos.addKeyListener(new java.awt.event.KeyAdapter() {
			...
			public void keyPressed(java.awt.event.KeyEvent evt) {
				if (evt.getKeyChar() == java.awt.event.KeyEvent.VK_ENTER) {
					String ruta = (String) tableModelDocumentos
							.getValueAt(jtblDocumentos.convertRowIndexToModel(jtblDocumentos.getSelectedRow()), 0);
	...
	private void initComponents() {
		...
		jtblDocumentos.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null } },
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addComponent(jblMensaje, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				javax.swing.GroupLayout.Alignment.TRAILING,
				layout.createSequentialGroup()
						.addComponent(jblMensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 15,
