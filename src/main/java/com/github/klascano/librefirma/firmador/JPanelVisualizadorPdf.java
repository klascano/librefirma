...
public final class JPanelVisualizadorPdf extends javax.swing.JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1072060359654370792L;
	private static final Logger LOGGER = Logger.getLogger(JPanelVisualizadorPdf.class.getName());
	...
	private void eventos() {
		...
		jScrollPanel.getViewport().addChangeListener(e -> {
			if (tmpPage > 0 && tmpPage == getPagina()) {
				...
				preview.getGraphics().drawImage(image, ((point.x * getZoom()) / tmpZoom) + width,
						((point.y * getZoom()) / tmpZoom) + height, tmpSignatureWidth, tmpSignatureHeight, null);
			}
		});
		// ============= SET PAGE =====================
		...
		label.addMouseListener(new java.awt.event.MouseAdapter() {
			...
			public void mouseClicked(java.awt.event.MouseEvent e) {
				...
				case java.awt.event.MouseEvent.BUTTON1: {
					...
					width = (preview.getWidth() - label.getWidth()) / 2;
					height = (preview.getHeight() - label.getHeight()) / 2;
					if ((e.getPoint().x < iconImage.getIconWidth() - tmpSignatureWidth)
						...
						JOptionPane.showMessageDialog(preview,
								"Fuera de margen,\nSe estampa la firma en la posición superior izquierda de la hoja actual.",
								"Error", javax.swing.JOptionPane.ERROR_MESSAGE);
						point.setLocation(0, 0);
					}
					tmpPage = getPagina();
					tmpZoom = getZoom();
					preview.getGraphics().drawImage(image, point.x + width, point.y + height, tmpSignatureWidth,
							tmpSignatureHeight, null);
				}
	...
	public File getDocumento() {
		try {
			...
			javax.swing.JOptionPane.showMessageDialog(null,
					"Problema en membrete del documento (cabecera y/o pie de pagina)\n" + documento, "Error",
					javax.swing.JOptionPane.ERROR_MESSAGE);
			java.util.logging.Logger.getLogger(JPanelVisualizadorPdf.class.getName())
					.log(java.util.logging.Level.SEVERE, null, iae);
		} catch (IOException ex) {
			javax.swing.JOptionPane.showMessageDialog(null,
					"Se ha detectado problemas al cargar el documento\n" + documento, "Error",
					javax.swing.JOptionPane.ERROR_MESSAGE);
			java.util.logging.Logger.getLogger(JPanelVisualizadorPdf.class.getName())
	...
	private boolean a4(PDRectangle pageSize) {
		...
		/* A4 vertical */
		if (pageSize.getWidth() >= (int) PDRectangle.A4.getWidth() - aproximado
				&& pageSize.getWidth() <= (int) PDRectangle.A4.getWidth() + aproximado) {
			if (pageSize.getHeight() >= (int) PDRectangle.A4.getHeight() - aproximado
					&& pageSize.getHeight() <= (int) PDRectangle.A4.getHeight() + aproximado) {
				a4Vertical = true;
			}
		}
		/* A4 horizontal */
		if (pageSize.getWidth() >= (int) PDRectangle.A4.getHeight() - aproximado
				&& pageSize.getWidth() <= (int) PDRectangle.A4.getHeight() + aproximado) {
			if (pageSize.getHeight() >= (int) PDRectangle.A4.getWidth() - aproximado
					&& pageSize.getHeight() <= (int) PDRectangle.A4.getWidth() + aproximado) {
				a4Horizontal = true;
			}
		}
	...
	private void loadPreview(int page, int zoom) {
		...
		if (!a4(pageSize)) {
			String pageformat = "La hoja del documento no cumple con el formato A4 Horizontal (595 x 842 pixeles) o Vertical (842 x 595 pixeles)\n\nEl tamaño actual es: "
					+ (int) pageSize.getHeight() + " x " + (int) pageSize.getWidth() + " pixeles";

			LOGGER.warning(pageformat);
	...
	private void initComponents() {
		...
		previewLayout.setHorizontalGroup(previewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGap(0, 768, Short.MAX_VALUE));
		previewLayout.setVerticalGroup(previewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
								...
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jlblRazon, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jlblRuta, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jtxRazonFirma).addComponent(jScrollPane1)))
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup().addComponent(jlblMensaje).addGap(18, 18, 18)
												.addComponent(jblNroPagina, javax.swing.GroupLayout.PREFERRED_SIZE, 64,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jspNumPages, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jblNroPaginaTotal, javax.swing.GroupLayout.PREFERRED_SIZE,
														40, javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jblZoom)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jspZoom, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jblNroZoom, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addContainerGap()))));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jtxRazonFirma, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jlblRazon))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jspZoom, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jblZoom).addComponent(jblNroZoom)
								.addComponent(jspNumPages, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jblNroPagina).addComponent(jblNroPaginaTotal).addComponent(jlblMensaje))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								...
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addGroup(
												layout.createSequentialGroup()
														.addComponent(jlblRuta, javax.swing.GroupLayout.PREFERRED_SIZE,
